...
scopes:
  ...
  - admin       # Admin users & RBAC
  - user        # Customer profile & follow
  - video       # Video CRUD & likes
  - task        # Task system & rewards
  - report      # Report endpoints
  - repo        # sqlc queries & repository
  - db          # Migrations & schema
  - middleware  # HTTP middleware
  - core        # Error model & response format
