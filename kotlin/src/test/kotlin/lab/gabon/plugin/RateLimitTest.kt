...
class RateLimitTest {
    ...
    @Test
    fun `request within limit returns 200 with rate limit headers`() =
        testApplication {
    ...
    @Test
    fun `request at exact limit returns 200 with zero remaining`() =
        testApplication {
    ...
    @Test
    fun `request exceeding limit returns 429 with retry-after`() =
        testApplication {
    ...
    @Test
    fun `different rate limit groups are independent`() =
        testApplication {
    ...
    @Test
    fun `custom window seconds reflected in retry-after`() =
        testApplication {
    ...
    @Test
    fun `lua script receives correct key prefix`() =
        testApplication {
            val capturedKeys = mutableListOf<String>()
            coEvery {
                redis.eval<Long>(any<String>(), any<ScriptOutputType>(), any<Array<String>>(), any(), any(), any())
