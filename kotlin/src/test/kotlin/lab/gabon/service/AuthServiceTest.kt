...
class AuthServiceTest {
    ...
    @Test
    fun `register - success creates customer and returns tokens`() =
        runTest {
    ...
    @Test
    fun `register - duplicate username throws UsernameExists`() =
        runTest {
    ...
    @Test
    fun `register - username too short throws BadRequest`() =
        runTest {
            val ex =
                assertFailsWith<AppException> {
    ...
    @Test
    fun `register - password too short throws BadRequest`() =
        runTest {
            val ex =
                assertFailsWith<AppException> {
    ...
    @Test
    fun `login - success returns tokens and updates last login`() =
        runTest {
    ...
    @Test
    fun `login - wrong password throws InvalidCredentials`() =
        runTest {
            coEvery { customerRepo.findByUsername("alice") } returns aliceRow()
    ...
    @Test
    fun `login - nonexistent user throws InvalidCredentials`() =
        runTest {
    ...
    @Test
    fun `refresh - success with valid refresh token`() =
        runTest {
    ...
    @Test
    fun `refresh - access token rejected as not a refresh token`() =
        runTest {
            val tokenPair = jwtService.generateCustomerTokens(1L)
    ...
    @Test
    fun `refresh - missing family throws token invalid`() =
        runTest {
            val tokenPair = jwtService.generateCustomerTokens(1L)
    ...
    @Test
    fun `refresh - replay detected (CAS conflict) throws and revokes family`() =
        runTest {
            val tokenPair = jwtService.generateCustomerTokens(1L)
    ...
    @Test
    fun `logout - blacklists JTI and deletes family`() =
        runTest {
    ...
    @Test
    fun `changePassword - success updates hash`() =
        runTest {
    ...
    @Test
    fun `changePassword - wrong old password throws PasswordMismatch`() =
        runTest {
            coEvery { customerRepo.findById(1L) } returns aliceRow()
    ...
    @Test
    fun `changePassword - nonexistent customer throws NotFound`() =
        runTest {
    ...
    @Test
    fun `getMe - returns profile for existing customer`() =
        runTest {
            coEvery { customerRepo.findById(1L) } returns aliceRow()
    ...
    @Test
    fun `getMe - nonexistent customer throws NotFound`() =
        runTest {
            coEvery { customerRepo.findById(999L) } returns null
