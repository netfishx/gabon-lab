...
class AuthRoutesTest {
    ...
    private val secret123Hash: String by lazy {
        at.favre.lib.crypto.bcrypt.BCrypt
            .withDefaults()
            .hashToString(4, "secret123".toCharArray())
    }
    ...
    @Test
    fun `register - success returns 201 with tokens`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `login - success returns 200 with tokens`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `login - nonexistent user returns 401`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `me - with valid token returns 200 with profile`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `me - with blacklisted token returns 401`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `change password - success returns 200`() =
        testApplication {
            setupApp()
            coEvery { tokenStore.isBlacklisted(any()) } returns false
            coEvery { customerRepo.findById(1L) } returns aliceRow()
    ...
    @Test
    fun `change password - wrong old password returns 400`() =
        testApplication {
            setupApp()
            coEvery { tokenStore.isBlacklisted(any()) } returns false
            coEvery { customerRepo.findById(1L) } returns aliceRow()
    ...
    @Test
    fun `logout - success blacklists JTI and deletes family`() =
        testApplication {
            setupApp()
            coEvery { tokenStore.isBlacklisted(any()) } returns false
    ...
    @Test
    fun `refresh - success returns new tokens`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `refresh - with access token returns 401`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `refresh - with expired family returns 401`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `refresh - replay detected revokes family and returns 401`() =
        testApplication {
            setupApp()
    ...
    @Test
    fun `me - admin token rejected on customer endpoint returns 401`() =
        testApplication {
            setupApp()
